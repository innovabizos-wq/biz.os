...
export const PLATFORM_MODULES = [
  ...
  {
    code: "billing",
    description: "Configuracion fiscal y facturacion electronica Hacienda.",
    healthKeys: ["configuration", "credentials", "external_api", "last_error"],
    kind: "optional",
    name: "Facturacion",
    order: 80,
    requiredConfigKeys: ["fiscal"],
    requiredPermissions: ["billing.fiscal.view", "billing.invoices.view"],
    routes: ["/admin/fiscal"],
    softDependencies: ["sales", "payments"],
  },
  {
    code: "whapp",
    description: "Operacion WhatsApp/Meta sobre Inbox, webhooks y conversaciones.",
